	...
	<div class="padding"></div>
		...
		<div class="container">
			<div class="row main">
				...
				<p>Greetings! 
					This is to inform you that,  you will be sent an email from the official email id of TEDxIGDTU (tedxigdtu2019@gmail.com) after your application is shortlisted. It will also contain the further details you will have to follow. (Ticket price : INR 450/-)<br/><br/><span class="red-text" >*Required</span>
				</p>
